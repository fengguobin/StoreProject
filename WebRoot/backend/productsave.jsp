...
<html>
	...
	<script type="text/javascript">
		$(function(){
			...
			$("#submit").click(function(){
				...
				{
					$("#ff").form("submit",{
						url:"${store}/ProductServlet?method=save",
						success:function(){
  ...
  <body>
  	<form id="ff" method="post" enctype="multipart/form-data">
  		<input type="hidden" name="company_id" value="${bCompany.id}"/>
  		<div>
  		...
  		<div>
  			...
  			<input type="radio" id="mrm" name="hot" value="0" checked="checked"/>
  		</div>  
  		
  		<div>
  			商品状态：
  			<label for="state">正常上架</label>
  			<input type="radio" id="state" name="state" value="0" checked="checked"/>&nbsp;&nbsp;
