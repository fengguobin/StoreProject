...
<html>
  ...
  <body class="easyui-layout">
  		<div data-options="region:'north',title:'欢迎商家${bCompany.name}来到商城后台管理',split:true" style="height:100px;"></div>     
        <div data-options="region:'west',title:'系统操作',split:true" style="width:200px;">  
            ...
            <div id="menu" class="easyui-accordion" data-options="fit:true">     
                <div title="基本操作" data-options="iconCls:'icon-save'">     
                    <ul>  
                        <li><a href="#" title="${store}/backend/productquery.jsp">商品管理</a>  
                        <li><a href="#" title="${store}/backend/orderquery.jsp">订单管理</a>  
                    </ul>  
                </div>     
            </div>     
        </div>     
