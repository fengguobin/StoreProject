		...
		<script type="text/javascript">
		 $(function(){  
	            $('#dg').datagrid({     
	                ...
	                loadMsg:'Loading......',  
	                queryParams:{searchWord:"",method:"queryUser"},//参数  
	                //width:300,  
	               ...
	               // singleSelect:true, //如果为真，只允许单行显示，全选功能失效  
							...
							handler: function(){
								...
								}else
								{
										parent.$("#win").window({
											...
											modal:true,
											title:"编辑用户",
											content:'<iframe src="${store}/backend/userupdate.jsp" frameborder="0" width="100%" height="100%"></iframe>'
										});
								...
								if(rows.length==0)
								{
									...
									$.messager.confirm("删除确定对话框","删除所选数据",function(r){
										if(r)
										{
											...
											//准备发送ajax请求到服务端
											var url="${store}/UserServlet?method=deleteByIds";
											var content={"ids":ids};
	                ...
	                columns:[[                       
	                    ...
	                    {
	                    	field:'state',title:'激活状态',width:100,
	        	...
	        	//把文本框变成搜索文本框
	             $("#ss").searchbox({
	             	searcher:function(value,name){
	             		...
	             		$("#dg").datagrid("load",{searchWord:value,method:queryUser})
	             	},
	             	prompt:'请输入要搜索的用户帐号'
	             });
	        });  
